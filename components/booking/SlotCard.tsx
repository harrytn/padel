...
/** Explicit padding on the base container */
const BASE = "flex flex-col justify-between min-h-[104px] rounded-2xl w-full text-left transition-all duration-200 border px-[24px] py-[16px]";
    ...
    return (
      ...
      >
        <div className="flex items-start justify-between w-full">
          ...
          {isPeak && (
            <span className="bg-white/20 text-white text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 shrink-0">
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between w-full">
        ...
        {isPeak && (
          <span className="bg-[#EEBB3B]/20 text-[#1E2438] text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 shrink-0">
