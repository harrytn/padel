...
export const translations: Record<Language, Translations> = {
  fr: {
    ...
    checkout_room_placeholder: "Ex: 2306",
    ...
    error_room_invalid: "Le numéro de chambre doit contenir exactement 4 chiffres.",
  ...
  en: {
    ...
    checkout_room_placeholder: "e.g. 2306",
    ...
    error_room_invalid: "Room number must be exactly 4 digits.",
  ...
  de: {
    ...
    checkout_room_placeholder: "z.B. 2306",
    ...
    error_room_invalid: "Die Zimmernummer muss genau 4 Ziffern enthalten.",
